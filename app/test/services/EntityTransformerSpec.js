...
(function () {
  ...
  describe('EntityTransformerFactory', function () {
    var httpBackendMock;
    var factory;

    beforeEach(module('app.services.entity.transformer'));

    beforeEach(inject(function($httpBackend, EntityTransformerFactory) {
      httpBackendMock = $httpBackend;
      factory = EntityTransformerFactory;
    }));
